...
--}}
<x-modal id="edit-trailer">
    <form class="flex flex-col items-center w-full gap-2" id="edit-trailer-form">
        @csrf
        <x-wrapper-form-1>
            <x-tittle-form>Edit Trailer</x-tittle-form>
            <x-input-1 type="hidden" name="trailer_id"></x-input-1>
            <x-wrapper-form-2>
        ...
        <x-wrapper-form-1>
            ...
            <x-button-1 id="update-trailer" colorBtn="blue">Finish</x-button-1>
        </x-wrapper-form-1>
    </form>
</x-modal>
@push('js')
...
$(document).ready(function(){
    function updateTrailer(){
        $("#edit-trailer-form").submit(function(event) {
            event.preventDefault();
            var form = $('#edit-trailer-form')[0];
            var data = new FormData(form);
            var id = $('#trailer_id').val();
            ...
            $.ajax({
                ...
                success: function(){
                    Swal.fire({
                        icon: 'success',
                        title: 'Success',
                        text: 'The Trailer was updated successfully.',
                ...
                error:function(){
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'An error occurred while updated the Trailer.',
                        confirmButtonText: 'OK'
                    });
                }
            });
