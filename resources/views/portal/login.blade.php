...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <div class="text-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Acceso a Clientes</h1>
            <p class="text-sm text-gray-500 mt-2">Ingresa para ver y descargar tus documentos</p>
        </div>

        @if($errors->any())
            <div class="bg-red-50 text-red-600 p-3 rounded-md text-sm mb-4">
                {{ $errors->first() }}
            </div>
        @endif
