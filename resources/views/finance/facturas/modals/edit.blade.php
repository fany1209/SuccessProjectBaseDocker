            ...
            <div class="producto-row bg-gray-50 border border-gray-200 rounded-lg p-3 shadow-sm relative mt-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-2 items-end mb-3">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <input name="productos[${editIndexNew}][precio_unitario]" type="number" step="any" class="w-full border rounded px-2 py-1 text-sm precio-unitario" required>
                    </div>
                    <div class="md:col-span-2">
                        <label class="text-sm font-medium text-gray-700">Importe Base</label>
                        <input name="productos[${editIndexNew}][precio]" type="number" step="any" readonly class="w-full border border-gray-300 rounded px-2 py-1 text-sm precio bg-gray-200 font-bold text-right" required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-9 gap-2 items-end pt-2 border-t border-gray-200">
                    <div class="flex flex-col">
                        ...
                        <input name="productos[${editIndexNew}][descuento]" type="number" step="any" value="0" class="w-full border rounded px-2 py-1 text-sm descuento text-orange-600 font-semibold">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-sm font-medium text-green-600">Base IVA</label>
                        <input name="productos[${editIndexNew}][base_iva]" type="number" step="any" class="w-full border rounded px-2 py-1 text-sm base-iva text-center font-semibold text-green-600" placeholder="Auto">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-sm font-medium text-gray-700">% IVA</label>
                        <input name="productos[${editIndexNew}][iva_porcentaje]" value="16" type="number" step="any" class="w-full border rounded px-2 py-1 text-sm iva-pct text-center">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-sm font-medium text-gray-700">% Otro</label>
                        <input name="productos[${editIndexNew}][otro_impuesto]" value="0" type="number" step="any" class="w-full border rounded px-2 py-1 text-sm otro-pct text-center">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-sm font-medium text-blue-600">Trasl. $</label>
                        <input name="productos[${editIndexNew}][traslado]" value="0" type="number" step="any" class="w-full border rounded px-2 py-1 text-sm traslado text-center font-semibold text-blue-600">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-sm font-medium text-purple-600">ILC $</label>
                        <input name="productos[${editIndexNew}][ilc]" value="0" type="number" step="any" class="w-full border rounded px-2 py-1 text-sm ilc text-center font-semibold text-purple-600">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-sm font-medium text-red-600">Reten. $</label>
                        <input name="productos[${editIndexNew}][retencion]" value="0" type="number" step="any" class="w-full border rounded px-2 py-1 text-sm retencion text-center font-semibold text-red-600">
                    </div>
                    <div class="flex flex-col">
                        <label class="text-sm font-medium text-red-800">ISR $</label>
                        <input name="productos[${editIndexNew}][isr]" value="0" type="number" step="any" class="w-full border rounded px-2 py-1 text-sm isr text-center font-semibold text-red-800">
                    </div>
