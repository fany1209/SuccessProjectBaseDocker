...
<head>
    ...
    <title>Success - Nutrición Ganado Bovino</title>
    ...
    <div class="container py-5">
        ...
        <div class="text-center mb-16 reveal" style="animation-delay: 0.2s">
            <h1 class="text-6xl md:text-7xl font-black italic uppercase tracking-tighter mb-4">
                Línea <span class="text-green-500">Bovina</span>
            </h1>
            <p class="text-gray-400 text-lg max-w-2xl mx-auto">
               Mejora el rendimiento y la calidad de producción de tu ganado bovino.|1
            </p>
        </div>
        ...
        <div class="row g-5">
            @php
                $productos = [
                    [
                        'tit' => 'Levaflesh', 
                        'tag' => 'Aditivo para engorda de bovinos', 
                        'desc' => 'Concentrado de alta energía para finalización acelerada y marmoleo superior en canales.',
                        'img' =>  'vaca-sch1.png'
                    ],
                    [
                        'tit' => 'Lactolev', 
                        'tag' => 'Aditivo para vacas lecheras', 
                        'desc' => 'Balance mineral y proteico diseñado para sostener picos de lactancia y mejorar sólidos totales.',
                        'img' => 'vaca-sch2.png'
                    ],
                ];
            @endphp
            ...
            <div class="col-12 col-lg-6 reveal" style="animation-delay: {{ ($index + 3) * 0.1 }}s">
                <div class="product-card">
                    <div class="img-wrapper">
                        <img src="{{ asset('images/'.$p['img']) }}" class="product-img" alt="Success Bovino">
                    </div>
        ...
        <footer class="mt-32 pb-10 text-center reveal" style="animation-delay: 1s">
            ...
            <p class="text-gray-600 text-xs tracking-widest uppercase mb-4">Success Nutrición Animal © 2026</p>
