...
<head>
    ...
    <title>Success Pet Food - Nutrición Canina</title>
    ...
    <div class="container py-5">
        ...
        <div class="text-center mb-16 reveal" style="animation-delay: 0.2s">
            <h1 class="text-6xl md:text-7xl font-black italic uppercase tracking-tighter mb-4">
                Línea <span class="text-green-500">Health & Pet Dog</span>
            </h1>
            <p class="text-gray-400 text-lg max-w-2xl mx-auto">
                Nutrición equilibrada de grado superior para la salud, vitalidad y longevidad de tu mejor amigo.
            </p>
        </div>
            ...
            <div class="col-12 col-lg-6 reveal" style="animation-delay: {{ ($index + 3) * 0.1 }}s">
                <div class="product-card">
                    <div class="img-wrapper">
                        <img src="{{ asset('images/'.$p['img']) }}" class="product-img" alt="Success Perros">
                    </div>
