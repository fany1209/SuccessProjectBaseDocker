...
<div class="mx-6 py-6">
    ...
    <form id="editQuoteForm" action="{{ route('quotes.update', $quote->quote_id) }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 text-sm">
            <div><label class="block font-bold text-gray-700">Atención</label><input type="text" name="attention" class="w-full border-gray-300 rounded p-2" value="{{ $quote->attention }}"></div>
            <div><label class="block font-bold text-gray-700">Departamento</label><input type="text" name="department" class="w-full border-gray-300 rounded p-2" value="{{ $quote->department }}"></div>
            <div><label class="block font-bold text-gray-700">Teléfono</label><input type="text" name="phone" class="w-full border-gray-300 rounded p-2" value="{{ $quote->phone }}"></div>
        </div>
