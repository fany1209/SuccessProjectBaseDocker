...
--}}
<section id="update-sale-blade" class="flex flex-col items-center w-full lg:w-3/4 rounded-lg bg-gray-50 shadow-md px-4 py-2 hidden">
    <div class="flex justify-between items-center w-full gap-2">
        <h2 class="my-2 text-2xl row-span-1 row-start-1 w-full border-s-4 border-green-700 ps-2">Update Sale</h2>
        <x-button id="close-update-sale-blade" class="bg-red-500 hover:bg-red-600 focus:bg-red-600 active:bg-red-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150">Close</x-button>
    </div>
    <form class="flex flex-col lg:flex-row lg:justify-center items-start w-full gap-3 mt-2" id="update-sale-form">
        ...
        <div class="flex flex-col items-center w-full lg:w-3/4">
            ...
            <div class="flex justify-between items-center w-full gap-2 border-b-2 border-gray-200 pb-2">
                ...
                <div class="flex flex-col items-start gap-1 w-full" id="customer-opt">
                    ...
                    <div class="accordion-body w-full hidden">
                        <div class="flex justify-between items-center w-full gap-2">
                            <div class="flex flex-col items-start gap-1 w-full">
                                ...
                                <input disabled type="email" id="email" name="email" maxlength="150" class="w-full rounded-lg border border-gray-300 text-gray-400 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 px-2 py-2">
                            </div>
                            <div class="flex flex-col items-start gap-1 w-full">
                                <label for="phone" class="mb-1 block font-medium text-md text-gray-700">Phone</label>
                                <input disabled type="text" id="phone" name="phone" maxlength="20" class="w-full rounded-lg border border-gray-300 text-gray-400 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 px-2 py-2">
                            </div>
                        </div>
                        <div class="flex justify-between items-center w-full gap-2">
                            <div class="flex flex-col items-start gap-1 w-full">
                                <label for="rfc" class="mb-1 block font-medium text-md text-gray-700">RFC</label>
                                <input disabled type="text" id="rfc" name="rfc" maxlength="13" class="w-full rounded-lg border border-gray-300 text-gray-400 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 px-2 py-2">
                            </div>
                            <div class="flex flex-col items-start gap-1 w-full">
                                <label for="address" class="mb-1 block font-medium text-md text-gray-700">Address</label>
                                <input disabled type="text" id="address" name="address" maxlength="200" class="w-full rounded-lg border border-gray-300 text-gray-400 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 px-2 py-2">
                            </div>
                        </div>
                        <div class="flex justify-between items-center w-full gap-2">
                            <div class="flex flex-col items-start gap-1 w-full">
                                <label for="city" class="mb-1 block font-medium text-md text-gray-700">City</label>
                                <input disabled type="text" id="city" name="city" maxlength="80" class="w-full rounded-lg border border-gray-300 text-gray-400 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 px-2 py-2">
                            </div>
                            <div class="flex flex-col items-start gap-1 w-full">
                                <label for="district" class="mb-1 block font-medium text-md text-gray-700">District</label>
                                <input disabled type="text" id="district" name="district" maxlength="80" class="w-full rounded-lg border border-gray-300 text-gray-400 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 px-2 py-2">
                            </div>
                        </div>
                        <div class="flex justify-between items-center w-full gap-2">
                            <div class="flex flex-col items-start gap-1 w-full">
                                <label for="state" class="mb-1 block font-medium text-md text-gray-700">State</label>
                                <input disabled type="text" id="state" name="state" maxlength="80" class="w-full rounded-lg border border-gray-300 text-gray-400 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 px-2 py-2">
                            </div>
                            <div class="flex flex-col items-start gap-1 w-full">
                                <label for="country" class="mb-1 block font-medium text-md text-gray-700">Country</label>
                                <input disabled type="text" id="country" name="country" maxlength="100" class="w-full rounded-lg border border-gray-300 text-gray-400 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 px-2 py-2">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex flex-col justify-between items-end w-full gap-4 lg:w-1/4">
            <div class="flex flex-col items-center w-full gap-4 shadow-md rounded-md px-4 py-1">
                ...
                <div class="flex flex-col items-start w-full gap-2 border-b-2 border-dashed border-gray-400 pb-2">
                    ...
                    <span id="seller-selected" class="tracking-[2px] text-md bg-gray-700 text-white px-1 rounded-md"></span>
                </div>
                <div class="flex justify-between items-start w-full gap-2 border-b-2 border-dashed border-gray-400 pb-2">
                    ...
                    <span id="products-count" class="tracking-[2px] text-md bg-gray-700 text-white px-1 rounded-md">0</span>
                </div>
                <div class="flex flex-col items-start w-full gap-2 border-b-2 border-dashed border-gray-400 pb-2">
            ...
            <div class="flex justify-end items-start w-full gap-2">
                <x-button type="submit" id="update-sale" class="bg-blue-500 hover:bg-blue-600 focus:bg-blue-600 active:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">Finish</x-button>
            </div>
        </div>
    </form>
   <div id="product-template-update" class="hidden">
    <div class="wrapper flex flex-col items-start w-full gap-2 rounded-md p-2 border-2 border-dashed border-gray-300 relative">
        <span class="remove-btn-2 absolute top-1 right-1 bg-red-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs cursor-pointer">X</span>
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between items-center w-full gap-2">
            <div class="flex justify-between items-center w-full gap-2">
                ...
                <div class="flex flex-col items-start gap-1 w-full">
                    ...
                    <input type="text" name="public_batch[]" maxlength="100" class="public-batch w-full rounded-lg border border-gray-300 text-gray-400 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 px-2 py-2">
                </div>
            </div>
            <div class="flex justify-between items-center w-full gap-2">
                <div class="flex flex-col items-start gap-1 w-full">
        ...
        <div class="flex flex-col lg:flex-row lg:justify-between items-center w-full gap-2">
            <div class="flex justify-between items-center w-full gap-2">
                ...
                <div class="flex flex-col items-start gap-1 w-full">
                    ...
                    <span class="tax-btn-2 flex justify-center items-center w-full transition border-2 border-gray-400 hover:bg-blue-300 text-gray-700 hover:text-white p-1 tracking-[3px] text-lg cursor-pointer rounded-md">No</span>
...
<script>
    ...
    $(function(){
        function reactiveUpdateSale(){
            ...
            $('#update-sale-form #customer-btn').on('click',function () {
                const father = $('#update-sale-form');
                const btn = $(this);
                if(btn.hasClass('border-green-400')){ 
                    btn.text('No').removeClass('border-green-400 bg-green-400 text-white').addClass('border-gray-400 hover:bg-green-300 text-gray-700 hover:text-white');
                    ...
                    father.find('#customer-1, #customer-1-id, #email, #phone, #rfc, #address, #city, #district, #state, #country').val('');
                    ...
                    father.find('#prospect-2, #prospect-2-id, #email, #phone, #rfc, #address, #city, #district, #state, #country').val('');
                    father.find('#client-tag').text('Customer name');
                    father.find('#client-name, #client-selected').text('');
                }
            });

            $('#update-sale-form #customer-1, #update-sale-form #prospect-2').on('dblclick', function() {
                $(this).val(''); 
            ...
            $('#update-sale-form #prospect-2').on('input',function(){
                const father = $('#update-sale-form');
                const raw = ($(this).val() || '').trim();
                const id = parseInt(raw.split(' - ')[0], 10) || 0;
                father.find('#prospect-2-id').val(id ? String(id) : '');
                ...
                if(id !== 0){
                    $.ajax({
                        ...
                        url: `/prospects/${id}`,
                        success: function(r){
                            father.find('#client-name, #client-selected').text(r.prospect['name']);
                            father.find('#email').val(r.prospect['email']);
                            father.find('#phone').val(r.prospect['phone']);
                            father.find('#rfc').val(r.prospect['rfc']);
                            father.find('#address').val(r.prospect['address']);
                            father.find('#city').val(r.prospect['city']);
                            father.find('#district').val(r.prospect['district']);
                            father.find('#state').val(r.prospect['state']);
                            father.find('#country').val(r.prospect['country']);
                        }
                    });
                }else{
                    father.find('#client-name, #client-selected').text('');
