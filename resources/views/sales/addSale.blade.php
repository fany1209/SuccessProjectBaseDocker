...
<section id="add-sale-blade"
    class="flex flex-col items-center w-full lg:w-3/4 rounded-lg bg-gray-50 shadow-md px-4 py-2 hidden">
    <div class="flex justify-between items-center w-full gap-2">
        <h2 class="my-2 text-2xl row-span-1 row-start-1 w-full border-s-4 border-green-700 ps-2">Create Sale
            {{ $total_sales + 1 }}</h2>
        <x-button id="close-add-sale-blade"
    ...
    <form class="flex flex-col lg:flex-row lg:justify-center items-start w-full gap-3 mt-2" id="add-sale-form">
        ...
        <div class="flex flex-col items-center w-full lg:w-3/4">
            ...
            <div class="flex justify-between items-center w-full gap-2 border-b-2 border-gray-500 pb-4">
                <div class="flex flex-col items-start gap-1 w-full">
                    ...
                    @if ($user_admin)
                        <select required id="seller" name="user_id"
                            class="w-full rounded-lg border border-gray-300 text-gray-400 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 px-2 py-2">
            ...
            <div class="flex justify-between items-center w-full gap-2">
                <div id="first-time-opt" class="flex flex-col items-start gap-1 w-full">
                    <label for="" id="first-time-tag" class="mb-1 block font-medium text-md text-gray-700">First
                        Time?</label>
                    <span id="first-time-btn"
                        class="flex justify-center items-center w-full transition border-2 border-green-400 bg-green-400 text-white p-1 tracking-[3px] text-lg cursor-pointer rounded-md">Yes</span>
                ...
                <div id="customer-opt" class="flex flex-col items-start gap-1 w-full hidden">
                    <label for="" id="customer-tag"
                        class="mb-1 block font-medium text-md text-gray-700">Customer?</label>
            ...
            <div class="flex justify-between items-center w-full gap-2">
                <div class="flex flex-col items-start gap-1 w-full">
                    <label for="name" id="client-tag" class="mb-1 block font-medium text-md text-gray-700">Prospect
                        name</label>
                    ...
                    <input required type="text" id="prospect-2" placeholder="Select a sector for view Prospects"
                    ...
                    <input required disabled type="text" id="customer-1" placeholder="Select a sector for view Customer"
                    ...
                    <div class="accordion-body w-full hidden">
                        ...
                        <div class="flex justify-between items-center w-full gap-2">
                            ...
                            <div class="flex flex-col items-start gap-1 w-full">
                                ...
                                <input type="text" id="district" name="district" maxlength="80"
                                    class="w-full rounded-lg border border-gray-300 text-gray-400 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 px-2 py-2">
                            </div>
                        </div>
                        <div class="flex justify-between items-center w-full gap-2">
                        ...
                        <div class="flex justify-between items-center w-full gap-2">
                            <div class="flex flex-col items-start gap-1 w-full">
                                <label for="product-id"
                                    class="mb-1 block font-medium text-md text-gray-700">Product</label>
                            ...
                            <div class="flex flex-col items-start gap-1 w-full">
                                <label for="public-batch" class="mb-1 block font-medium text-md text-gray-700">Public
                                    batch</label>
                                <input type="text" id="public-batch" name="public_batch[]" maxlength="100"
                                    class="w-full rounded-lg border border-gray-300 text-gray-400 focus:text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 px-2 py-2">
                            </div>
                        </div>
                        <div class="flex justify-between items-center w-full gap-2">
                            ...
                            <div class="flex flex-col items-start gap-1 w-full">
                                <label for="cost"
                                    class="cost-tag mb-1 block font-medium text-md text-gray-700">Cost</label>
                    ...
                    <div class="flex flex-col lg:flex-row lg:justify-between items-center w-full gap-2">
                        <div class="flex justify-between items-center w-full gap-2">
                            <div id="invoice-value-opt" class="flex flex-col items-start gap-1 w-full">
                                <label for="" class="mb-1 block font-medium text-md text-gray-700">Invoice
                                    Value?</label>
                                <span
                                    class="invoice-value-btn flex justify-center items-center w-full transition border-2 border-gray-400 hover:bg-green-300 text-gray-700 hover:text-white p-1 tracking-[3px] text-lg cursor-pointer rounded-md">No</span>
                            ...
                            <div class="flex flex-col items-start gap-1 w-full">
                                ...
                                <span
                                    class="tax-btn flex justify-center items-center w-full transition border-2 border-gray-400 hover:bg-blue-300 text-gray-700 hover:text-white p-1 tracking-[3px] text-lg cursor-pointer rounded-md">No</span>
                                <input type="hidden" class="has-tax" name="has_tax[]" value="0">
                            </div>
                            <div class="flex flex-col items-start gap-1 w-full">
                                <label for="public-product-name"
                                    class="mb-1 block font-medium text-md text-gray-700">Invoice product name</label>
        ...
        <div class="flex flex-col justify-between items-end w-full gap-4 lg:w-1/4">
            <div class="flex flex-col items-center w-full gap-4 shadow-md rounded-md px-4 py-1">
                ...
                <div class="flex flex-col items-start w-full gap-2 border-b-2 border-dashed border-gray-400 pb-2">
                    ...
                    <span id="seller-selected"
                        class="tracking-[2px] text-md bg-gray-700 text-white px-1 rounded-md">{{ $user_admin ? '' : $user_name }}</span>
                </div>
                <div
                    ...
                    <span id="products-count"
                        class="tracking-[2px] text-md bg-gray-700 text-white px-1 rounded-md">1</span>
                </div>
                <div class="flex flex-col items-start w-full gap-2 border-b-2 border-dashed border-gray-400 pb-2">
            ...
            <div class="flex justify-end items-start w-full gap-2">
                <x-button type="button" id="reset-sale-form"
                    class="bg-orange-500 hover:bg-orange-600 focus:bg-orange-600 active:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition ease-in-out duration-150">Reset
                    Sale</x-button>
                <x-button type="submit" id="save-sale"
    ...
    <div id="product-template" class="hidden">
        <div
            class="wrapper flex flex-col items-start w-full gap-2 rounded-md p-2 border-2 border-dashed border-gray-300 relative">
            <span
                class="remove-btn absolute top-1 right-1 bg-red-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs cursor-pointer">X</span>
        ...
        $(function () {
            ...
            function reactiveAddSale() {
                ...
                $('#add-sale-form #first-time-btn').on('click', function () {
                    const btn = $(this);
                    if (btn.hasClass('border-green-400')) {
                        // Switch First Time to No
                        btn.text('No').removeClass('border-green-400 bg-green-400 text-white').addClass('border-gray-400 hover:bg-green-300 text-gray-700 hover:text-white');
                        $('#first-time').val('0');
                        $('#customer-opt').removeClass('hidden');
                        
                        // Automatically set Customer to Yes
                        $('#customer-btn').text('Yes').removeClass('border-gray-400 hover:bg-green-300 text-gray-700 hover:text-white').addClass('border-green-400 bg-green-400 text-white');
                        $('#is-customer').val('1');
                        $('#client-tag').text('Customer name');

                        $('#customer-1').removeClass('hidden').prop('disabled', false);
                        ...
                        // Switch First Time to Yes
                        btn.text('Yes').removeClass('border-gray-400 hover:bg-green-300 text-gray-700 hover:text-white').addClass('border-green-400 bg-green-400 text-white');
                        $('#first-time').val('1');
                        $('#customer-opt').addClass('hidden');
                        
                        // Reset Customer opt
                        $('#customer-btn').text('No').removeClass('border-green-400 bg-green-400 text-white').addClass('border-gray-400 hover:bg-green-300 text-gray-700 hover:text-white');
                        $('#is-customer').val('0');
                        $('#client-tag').text('Prospect name');

                        $('#customer-1').addClass('hidden').prop('disabled', true).val('');
                        $('#prospect-1').addClass('hidden').prop('disabled', true).val('');
                        $('#prospect-2').removeClass('hidden').prop('disabled', false);
